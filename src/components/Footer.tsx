      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            >
              ...
              tools needed to protect against cyber threats in our increasingly
              digital world.
            </p>
            <div className="flex space-x-4 mt-6">
              <a
                href="https://github.com/atharva-aak/Cyber-Sentinel"
                target="_blank"
              ...
              <a
                href="mailto:atharvakalbande5@gmail.com"
                target="_blank"
                rel="noopener noreferrer"
                className={`transition-colors ${
                  isDarkMode
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p
              className={`text-sm mt-4 md:mt-0 transition-colors duration-300 ${
                isDarkMode ? "text-gray-400" : "text-gray-600"
              }`}
            >
